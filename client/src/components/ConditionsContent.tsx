...
const ConditionsContent = () => (
  <>
    <h1 className='font-extrabold text-primary md:text-5xl text-4xl p-8 text-center'>
      Statuts de l’ACQ et Conditions d’utilisation
    </h1>
    ...
    <section className="space-y-4">
      ...
      <ul className="list-disc pl-6 text-slate-700 space-y-2">
        ...
        <li>
          <strong>Membres actifs</strong> : Membre à jour de ses cotisations et qui participe régulièrement aux activités (AG, réunions mensuelles, activités sportives et culturelles, et bien d’autres) de l’Association.
        </li>
        <li>
    ...
    {/* À partir d’ici, l’accordéon commence au TITRE 1 */}
    <Accordion type="single" collapsible className="w-full mt-8">
      ...
      <AccordionItem value="titre3">
        ...
        <AccordionContent>
          ...
          <h4 className="mt-2 font-semibold">Article 17‑24 : Fonctions, réunions et attributions</h4>
          <p className="text-slate-700 text-justify leading-relaxed">
...
// import StatutsAssociation from '@/components/statutsAssociation'
